...
This also includes MLOps solutions.

For the last few years, I've been working as a Team Leader Data Scientist on multiple projects.
...
Developed MLOps architecture and code for Deep Learning models for well logs data analysis.
			\item 
Designed and developed software for Bayesian Networks plus serious optimizations of python library for Bayesian Networks.
			\item 
