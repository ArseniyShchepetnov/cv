...
\begin{document}
	...
	I have a good development performance with Python writing maintainable and structured code.
...
%-------------------------------------------------------------------------------------------------------------------------------	
	...
	\begin{minipage}[t]{\rmpratio\textwidth}
		...
		From year 2020 started leading 2 Junior Data Scientist.
		
		The main project was dedicated to saturation prediction, well logs correlation and product development with the features with deep learning and machine learning numerical modules.
		Project resulted in the MVP and some productive intervals (oil) predicted by the system were successfully perforated.	  
