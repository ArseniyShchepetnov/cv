...
For personal NLP project I have developed web scraping tool (ScraPy + MongoDB) and deployed it on Google Colab for NLP experiments.
...
Developed solutions for ML cryptocurrency traiding and ineer projects related to Data Science.

		\begin{itemize}
                \item 
During the first week in company I developed message classification model for customer support data analysis.
			\item 
I introduced changes in Data Science development process for both code and MLOps.
			\item 
