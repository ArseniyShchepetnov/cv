...
%-------------------------------------------------------------------------------------------------------------------------------	
	...
	\begin{minipage}[t]{\rmpratio\textwidth}
		...
		Research in the field of atomic physics supported by ``Helmholtz-Rosatom'' grant. Group leader \href{http://fock.phys.spbu.ru/glazov.htm}{Dmitry Glazov}. 
	...
	\begin{minipage}[t]{\rmpratio\textwidth}
		...
		Software development for military HF radio equipment on Linux. Business trips, tuning of equipment and documentation.\\[0.5cm]
