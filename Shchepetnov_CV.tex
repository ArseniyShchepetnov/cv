...
I have advanced development skills with Python including linting, CI/CD, FastAPI and others (see examples on GitHub), ability to create interactive visualisation tools and dashboards.
